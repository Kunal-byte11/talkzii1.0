...
export function NewLandingFooter() {
  return (
    <div id="footer-contact"> {/* Added ID here */}
      <footer className="flex flex-col gap-6 px-5 py-10 text-center @container bg-foreground text-background">
        <div className="flex justify-center gap-4">
          {/* Instagram Link */}
          <a href="https://www.instagram.com/talkzii.ai?igsh=Znc5NnZjYW0xazFq" target="_blank" rel="noopener noreferrer" aria-label="Talkzii on Instagram">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#833AB4" viewBox="0 0 24 24"> {/* Direct fill color for SVG */}
          ...
          {/* Twitter Link */}
          <a href="https://x.com/talkzii?t=-QxBTPHhN5XAbntxo9Fzfg&s=09" target="_blank" rel="noopener noreferrer" aria-label="Talkzii on Twitter">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#1DA1F2" viewBox="0 0 24 24"> {/* Direct fill color for SVG */}
